...
class ComposeFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        ivPreview = view.findViewById(R.id.iv_uploadImage)

        // Set onClickListeners and setup logic
        view.findViewById<Button>(R.id.btnTSubmit).setOnClickListener {
    ...
    private fun submitPost(description: String, user: ParseUser, file: File) {
        ...
        post.saveInBackground { e ->
            if (e != null) {
                ...
                Log.e(MainActivity.TAG, "Erro while saving post")
                e.printStackTrace()
                // show toast to tell user something went wrong with saving post

            } else {
                Log.i(MainActivity.TAG, "Succeessfully save post")
